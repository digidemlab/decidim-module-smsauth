...
FactoryBot.define do
  factory :signin_code_set, class: "Decidim::Smsauth::SigninCodeSet" do
    creator { create(:user, :confirmed, :admin, organization:) }
    generated_code_amount { 1 }
    used_code_amount { 0 }
    metadata do
      {
        school: Decidim::Smsauth::SchoolMetadata.school_options.map { |sc| sc[1] }.sample,
  ...
  factory :signin_code, class: "Decidim::Smsauth::SigninCode" do
    transient do
