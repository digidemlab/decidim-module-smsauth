...
module Decidim
  module Smsauth
    class SigninCode < ApplicationRecord
      belongs_to :signin_code_set, foreign_key: "decidim_signin_code_set_id", class_name: "::Decidim::Smsauth::SigninCodeSet"
      ...
      def generate!
        ...
        loop do
          ...
          return code if ::Decidim::Smsauth::SigninCode.find_by(code_hash:).blank?
        end
      end
