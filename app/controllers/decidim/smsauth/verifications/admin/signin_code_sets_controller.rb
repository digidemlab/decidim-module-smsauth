    ...
    module Verifications
      module Admin
        class SigninCodeSetsController < Decidim::Admin::ApplicationController
          include Decidim::Smsauth::Verifications::Admin::Filterable
          ...
          def collection
            ::Decidim::Smsauth::SigninCodeSet.all
          end

          def school_name(code)
            Decidim::Smsauth::SchoolMetadata.school_name(code)
          end
          ...
          def find_schools(query)
            schools = Decidim::Smsauth::SchoolMetadata.school_options
