      ...
      module Admin
        class SigninCodesController < Decidim::Admin::ApplicationController
          ...
          def create
            ...
            ::Decidim::Smsauth::Verifications::Admin::GenerateAccessCodes.call(@form) do
              on(:ok) do |codes|
          ...
          def generate_csv_file
            ...
            csv_data = CSV.generate(headers: true) do |csv|
              ...
              csv << [""]
              csv << [I18n.t(".access_codes", scope: "decidim.smsauth.verifications.admin.signin_codes.view_generated_codes")]
              codes.each do |code|
                csv << [code]
              end
            end
          ...
          def generate_xlsx_file
            ...
            sheet.add_cell(2, 0, I18n.t(".access_codes", scope: "decidim.smsauth.verifications.admin.signin_codes.view_generated_codes"))
          ...
          def set_expiration_info
            t("expiration_note", scope: "decidim.smsauth.verifications.admin.signin_codes.view_generated_codes", expiration_time:)
          end

          def global_expiration_period
            Decidim::Smsauth.global_expiration_period
          end
        end
      end
    end
